export enum ErrorCode {
  ...
  BookingTimeOutsidePrivateLinkWindow = "booking_time_outside_private_link_window",
  PrivateLinkWrongEventType = "private_link_wrong_event_type",
  ...
  InvalidBookingWindow = "invalid_booking_window",
